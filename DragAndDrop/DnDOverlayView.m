...
- (id)initWithDraggable:(UIView*)view dragSource:(UIView <DragSource>*)source initialPoint:(CGPoint)point;
@end
...
@synthesize overlayId = _overlayId;
@synthesize dragModeActive = _dragModeActive;
...
- (void)setOverlayId:(NSString *)overlayId {
    if(_overlayId != nil){
       // Don't support this
        @throw [NSException exceptionWithName:NSInternalInconsistencyException
                                       reason:@"ID of overlay view can't be changed"
                                     userInfo:nil];
    }
    
    _overlayId = overlayId;
    [[DnDManager instance] registerDnDOverlay:self withId:_overlayId];
}
